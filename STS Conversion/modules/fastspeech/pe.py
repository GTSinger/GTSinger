...
class PitchExtractor(nn.Module):
    ...
    def forward(self, mel_input=None, f0_mean=None, f0_std=None):
        ret = {}
        ...
        ret['f0_denorm_pred'] = denorm_f0_x(
            pitch_pred[:, :, 0], (pitch_pred[:, :, 1] > 0) if use_uv else None,
            hparams, pitch_padding=pitch_padding, mean=f0_mean, std=f0_std)
        return ret


def denorm_f0_x(f0, uv, hparams, pitch_padding=None, min=None, max=None, mean=None, std=None):
    f0_max = 1100.0
