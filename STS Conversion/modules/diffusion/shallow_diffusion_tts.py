...
class DiffusionDecoder(GaussianDiffusion):
    def __init__(self, phone_encoder, out_dims, denoise_fn, timesteps=1000, K_step=1000,
                 loss_type=hparams.get('diff_loss_type', 'l1'), betas=None, spec_min=None, spec_max=None):
        super(DiffusionDecoder, self).__init__(phone_encoder, out_dims, denoise_fn, timesteps, K_step, loss_type,
                                               betas, spec_min, spec_max)
        self.fs2 = None     # save space

    def forward(self, decoder_inp, txt_tokens=None, mel2ph=None, spk_embed=None,
                ref_mels=None, f0=None, uv=None, energy=None, infer=False, **kwargs):
